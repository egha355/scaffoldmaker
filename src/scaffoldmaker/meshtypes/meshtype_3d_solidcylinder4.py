...
class MeshType_3d_solidcylinder4(Scaffold_base):
    '''
    classdocs
    '''
    @staticmethod
    def getName():
        return '3D Solid Cylinder 4'
    ...
    def generateBaseMesh(region, options):
        ...
        for nz in range(elementsCountAlong+1):
            ...
            for nr in range(elementsCountThroughWall):
                for nt in range(elementsCountAround):
                    ...
                    dx_ds1 = [-majorRadius*sinRadiansAround*radiansPerElementAround*math.copysign(1,nt-elementsCountAround/2), minorRadius*cosRadiansAround*radiansPerElementAround*math.copysign(1,nt-elementsCountAround/2), 0.0]
        ...
        bni1=[1, 2, 3, 29, 28, 27, 26, 25, 24, 7, 6, 5]
        bni2=[2, 3, 4, 30, 29, 28, 27, 26, 25, 6, 5, 1]
        bni3=[8, 9, 10, 45, 44, 43, 42, 41, 40, 14, 13, 12]
        bni4=[9, 10, 11, 46, 45, 44, 43, 42, 41, 13, 12, 8]
        bni5=[19, 18, 17, 3, 2, 1, 5, 6, 7,22, 21, 20]
        bni6=[18, 17, 16, 4, 3, 2, 1, 5, 6, 21, 20, 19]
        bni7=[35, 34, 33, 10, 9, 8, 12, 13, 14, 38, 37, 36]
        bni8=[34, 33, 32, 11, 10, 9, 8, 12, 13, 37, 36, 35]
        ...
        nodeIdentifiers2=[7, 14, 23, 22, 39, 38]
        element = mesh.createElement(elementIdentifier, elementtemplate2)
        result = element.setNodesByIdentifier(eft2, nodeIdentifiers2)
        elementIdentifier += 1
